...
//        ]);
        ...
        $heroes = [
            ...
            [
                ...
                'attack' => 15,
                'defense' => 5,
                'model' => '/models/avatars/Avatar1.glb',
                'model_scale' => 1,
                'model_rotation' => null,
                'magic_types' => [],
            ],
            [
                ...
                'attack' => 18,
                'defense' => 6,
                'model' => '/models/avatars/DeadManWalking.glb',
                'model_scale' => 1,
                'model_rotation' => null,
                'magic_types' => [],
            ],
            [
                ...
                'attack' => 22,
                'defense' => 7,
                'model' => '/models/avatars/DemonTWiezzorek.glb',
                'model_scale' => 1,
                'model_rotation' => null,
                'magic_types' => ['fire'],
            ],
            [
                ...
                'attack' => 10,
                'defense' => 4,
                'model' => '/models/avatars/GoblinDshareyko.glb',
                'model_scale' => 1,
                'model_rotation' => null,
                'magic_types' => [],
            ],
            [
                ...
                'attack' => 9,
                'defense' => 3,
                'model' => '/models/avatars/GreenShortWitch.glb',
                'model_scale' => 1,
                'model_rotation' => null,
                'magic_types' => ['poison', 'heal'],
            ],
            [
                'name' => 'Maw',
                'health' => 100,
                ...
                'attack' => 25,
                'defense' => 9,
                'model' => '/models/avatars/MawJLaygo.glb',
                'model_scale' => 1,
                'model_rotation' => null,
                'magic_types' => [],
            ],
            [
                ...
                'attack' => 11,
                'defense' => 2,
                'model' => '/models/avatars/ParasiteLStarkie.glb',
                'model_scale' => 1,
                'model_rotation' => null,
                'magic_types' => ['poison'],
            ],
            [
                ...
                'attack' => 8,
                'defense' => 3,
                'model' => '/models/avatars/PeasantMan.glb',
                'model_scale' => 1,
                'model_rotation' => null,
                'magic_types' => [],
            ],
            [
                ...
                'attack' => 19,
                'defense' => 8,
                'model' => '/models/avatars/PumpkinhulkLShaw.glb',
                'model_scale' => 1,
                'model_rotation' => null,
                'magic_types' => [],
            ],
            [
                ...
                'attack' => 14,
                'defense' => 5,
                'model' => '/models/avatars/SkeletonzombieTAvelange.glb',
                'model_scale' => 1,
                'model_rotation' => null,
                'magic_types' => [],
            ],
            [
                ...
                'attack' => 16,
                'defense' => 6,
                'model' => '/models/avatars/UglyWarior.glb',
                'model_scale' => 1,
                'model_rotation' => null,
                'magic_types' => [],
            ],
            [
                ...
                'attack' => 17,
                'defense' => 6,
                'model' => '/models/avatars/VampireALusth.glb',
                'model_scale' => 1,
                'model_rotation' => null,
                'magic_types' => ['drain', 'chain'],
            ],
        ];
