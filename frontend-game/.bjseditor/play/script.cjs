...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/loading/loader.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/tools/guards.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/tools/light.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/rendering/vls.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/rendering/ssr.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/rendering/ssao.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/rendering/motion-blur.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/rendering/default-pipeline.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/rendering/tools.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/loading/physics.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/loading/rendering.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/decorators/apply.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/tools/sound.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/loading/script.js
var scriptAssetsCache = /* @__PURE__ */ new Map();
async function _preloadScriptsAssets(scene, rootUrl) {
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/loading/sound.js
var import_babylonjs21 = require("babylonjs");
var import_babylonjs22 = require("babylonjs");
var audioParser = (0, import_babylonjs22.GetParser)(import_babylonjs21.SceneComponentConstants.NAME_AUDIO);
(0, import_babylonjs22.AddParser)(import_babylonjs21.SceneComponentConstants.NAME_AUDIO, (parsedData, scene, container, rootUrl) => {
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/loading/texture.js
var import_babylonjs23 = require("babylonjs");

// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/tools/scalar.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/loading/texture.js
var textureParser = import_babylonjs23.SerializationHelper._TextureParser;
import_babylonjs23.SerializationHelper._TextureParser = (sourceProperty, scene, rootUrl) => {
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/loading/shadows.js
var import_babylonjs24 = require("babylonjs");
var import_babylonjs25 = require("babylonjs");
var shadowsGeneratorParser = (0, import_babylonjs25.GetParser)(import_babylonjs24.SceneComponentConstants.NAME_SHADOWGENERATOR);
(0, import_babylonjs25.AddParser)(import_babylonjs24.SceneComponentConstants.NAME_SHADOWGENERATOR, (parsedData, scene, container, rootUrl) => {
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/loading/sprite-map.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/tools/sprite.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/loading/sprite-map.js
(0, import_babylonjs32.AddParser)("SpriteMapNode", (parsedData, scene, container, rootUrl) => {
  parsedData.transformNodes?.forEach((transformNode) => {
    ...
    const atlasRequest = new import_babylonjs28.WebRequest();
    ...
    atlasRequest.addEventListener("load", () => {
      ...
      const imagePath = `${import_babylonjs26.Tools.GetFolderPath(atlasJsonAbsolutePath)}${atlasJson.meta.image}`;
      const spritesheet = new import_babylonjs30.Texture(imagePath, scene, false, false, import_babylonjs30.Texture.NEAREST_NEAREST, null, null, null, false, import_babylonjs27.Engine.TEXTUREFORMAT_RGBA);
      const spriteMap = new import_babylonjs29.SpriteMap(instance.name, atlasJson, spritesheet, {
        layerCount: transformNode.options.layerCount,
        stageSize: import_babylonjs31.Vector2.FromArray(transformNode.options.stageSize ?? [10, 1]),
        outputSize: import_babylonjs31.Vector2.FromArray(transformNode.options.outputSize ?? [100, 100]),
        colorMultiply: import_babylonjs31.Vector3.FromArray(transformNode.options.colorMultiply ?? [1, 1, 1]),
        flipU: true
      }, scene);
      transformNode.tiles.forEach((tile) => {
        for (let x = 0, lenX = tile.repeatCount.x + 1; x < lenX; ++x) {
          for (let y = 0, lenY = tile.repeatCount.y + 1; y < lenY; ++y) {
            ...
            spriteMap.changeTiles(tile.layer, new import_babylonjs31.Vector2(tile.position.x + offsetX, (spriteMap.options.stageSize?.y ?? 0) - 1 - tile.position.y - offsetY), tile.tile);
          }
        }
      });
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/loading/sprite-manager.js
...
function parseSerializedSpriteManager(spriteManager, parsedSpriteManager) {
  ...
  for (const parsedSprite of parsedSpriteManager?.sprites ?? []) {
    const sprite = import_babylonjs34.Sprite.Parse(parsedSprite, spriteManager);
...
(0, import_babylonjs37.AddParser)("SpriteManagerNode", (parsedData, scene, container, rootUrl) => {
  parsedData.transformNodes?.forEach((transformNode) => {
    ...
    if (transformNode.atlasJsonRelativePath) {
      ...
      atlasRequest.addEventListener("load", () => {
        ...
        const spriteManager = new import_babylonjs36.SpriteManager(instance.name, imagePath, 1e3, 64, scene, void 0, void 0, true, atlasJson);
      ...
      const spriteManager = new import_babylonjs36.SpriteManager(instance.name, imagePath, 1e3, {
...
async function loadScene(rootUrl, sceneFilename, scene, scriptsMap2, options) {
  ...
  await (0, import_babylonjs40.AppendSceneAsync)(`${rootUrl}${sceneFilename}`, scene, {
  ...
  if (import_babylonjs41.SceneLoaderFlags.ForceFullSceneLoadingForIncremental) {
  ...
  while (!scene.isDisposed && (!scene.isReady() || scene.getWaitingItemsCount() > 0)) {
    ...
    if (loadedItemsCount === waitingItemsCount) {
      scene.textures.forEach((texture) => {
        if (texture.delayLoadState === import_babylonjs39.Constants.DELAYLOADSTATE_NONE) {
          texture.delayLoadState = import_babylonjs39.Constants.DELAYLOADSTATE_LOADED;
        }
      });
    }
  ...
  if (scene.metadata?.physicsGravity) {
    scene.getPhysicsEngine()?.setGravity(import_babylonjs38.Vector3.FromArray(scene.metadata?.physicsGravity));
  }
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/loading/material.js
var import_babylonjs42 = require("babylonjs");

// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/tools/animation.js
var import_babylonjs43 = require("babylonjs");

// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/decorators/inspector.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/cinematic/parse.js
var import_babylonjs45 = require("babylonjs");
var import_babylonjs46 = require("babylonjs");
var import_babylonjs47 = require("babylonjs");

// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/cinematic/tools.js
var import_babylonjs44 = require("babylonjs");

// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/cinematic/generate.js
...
// Users/bozhidar/PhpstormProjects/OpenWorld3js/frontend-game/node_modules/babylonjs-editor-tools/build/src/cinematic/events/apply-impulse.js
...
var import_babylonjs_gui5 = require("babylonjs-gui");
var ChatComponent = class {
  constructor(mesh) {
    this.mesh = mesh;
  }
  static {
    __name(this, "ChatComponent");
  }
  advancedTexture;
  chatContainer;
  chatText;
  onStart() {
    const scene = this.mesh._scene || this.mesh.getEngine()?.scenes[0];
    if (!scene) {
      console.error("Could not access scene from mesh");
      return;
    }
    this.advancedTexture = import_babylonjs_gui2.AdvancedDynamicTexture.CreateFullscreenUI("ChatUI", true, scene);
    this.chatContainer = new import_babylonjs_gui4.Rectangle("chatContainer");
    ...
    this.chatContainer.horizontalAlignment = import_babylonjs_gui5.Control.HORIZONTAL_ALIGNMENT_LEFT;
    this.chatContainer.verticalAlignment = import_babylonjs_gui5.Control.VERTICAL_ALIGNMENT_BOTTOM;
    ...
    this.chatText = new import_babylonjs_gui3.TextBlock("chatText");
    ...
    this.chatText.textHorizontalAlignment = import_babylonjs_gui5.Control.HORIZONTAL_ALIGNMENT_LEFT;
    this.chatText.textVerticalAlignment = import_babylonjs_gui5.Control.VERTICAL_ALIGNMENT_TOP;
    this.chatText.horizontalAlignment = import_babylonjs_gui5.Control.HORIZONTAL_ALIGNMENT_LEFT;
    this.chatText.verticalAlignment = import_babylonjs_gui5.Control.VERTICAL_ALIGNMENT_TOP;
    this.chatText.width = 1;
    this.chatText.height = 1;
